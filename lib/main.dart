...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    twilioFlutter = TwilioFlutter(
        accountSid: 'ACed2c0e0ee0e4a2856e913d5d9aa84c73',
        authToken: '9766d06f92e4da3c3e370d92b8770deb',
        twilioNumber: '+12058461321');
                              ...
                              child: FlatButton(
                                ...
                                onPressed: (){
                                  ...
                                  /*Scaffold.of(context).showSnackBar(new SnackBar(
                                                content: new Text(recieveddata),backgroundColor: Colors.blue,));*/


                                  if(widget.usernameController.text=="") {

                                    Scaffold.of(context).showSnackBar(new SnackBar(
                                        content: new Text('You need to enter a username')));
                                    ...
                                    Scaffold.of(context).showSnackBar(new SnackBar(
                                        content: new Text('You need to enter a password')));
                        ...
                        child: Stack(
                          ...
                          Column(
                            children: <Widget>[
                              ...
                              Text("Welcome "+widget.usernameController.text,style: TextStyle(color: Colors.black,fontSize: 20),),
                                  ...
                                  child: Container(
                                    child: FlatButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        Scaffold.of(context).showSnackBar(new SnackBar(
                                            content: new Text(recieveddatastr),backgroundColor: Colors.blue,));*/
                                        ...
                                        if(widget.phoneController.text=="") {
                                          ...
                                          while(!recieveddatastr.contains("1")){


                                            Scaffold.of(context).showSnackBar(new SnackBar(
                                                content: new Text('Try to fetch data'),backgroundColor: Colors.blue,));


                                          }

                                          Scaffold.of(context).showSnackBar(new SnackBar(
                                              content: new Text('Data got fetched'),backgroundColor: Colors.green,));
        ...
        await BluetoothConnection.toAddress(_device.address)
          ...
          setState(() {
            ...
            connection.input.listen((Uint8List data) {
              ...
              recieveddata=ascii.decode(data);
              recieveddatastr= String.fromCharCodes(data);
            });
          });
